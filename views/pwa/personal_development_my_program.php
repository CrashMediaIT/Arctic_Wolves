...
.m-myprog-section-label {
    ...
    padding-top: 12px; border-top: 1px solid #2D2D3F;
    text-transform: uppercase; letter-spacing: 0.5px;
}
.m-myprog-section-label:first-of-type { border-top: none; margin-top: 0; padding-top: 0; }
...
.m-myprog-drill-header { display: flex; justify-content: space-between; align-items: center; }
.m-myprog-drill-title { font-size: 13px; font-weight: 600; color: #fff; margin-bottom: 2px; flex: 1; }
.m-myprog-drill-desc { font-size: 11px; color: #A8A8B8; line-height: 1.4; margin-top: 4px; }
...
.m-myprog-drill-video-link {
    ...
    padding: 8px 12px; background: rgba(59,130,246,0.15); color: #3B82F6;
...
.m-myprog-upload h4 { font-size: 13px; font-weight: 600; color: #fff; margin: 0 0 6px; }
.m-myprog-upload h4 i { margin-right: 4px; color: #8B5CF6; }
.m-myprog-upload p { font-size: 11px; color: #A8A8B8; margin: 0 0 10px; line-height: 1.4; }
.m-myprog-upload-opts { display: grid; grid-template-columns: 1fr 1fr; gap: 8px; margin-bottom: 10px; }
.m-myprog-upload-opt {
    background: #16161F; border: 1px solid #2D2D3F; border-radius: 8px;
    padding: 12px; text-align: center; cursor: pointer; min-height: 44px;
}
.m-myprog-upload-opt:active { border-color: rgba(107,70,193,0.4); }
.m-myprog-upload-opt i { font-size: 20px; color: #8B5CF6; display: block; margin-bottom: 4px; }
...
.m-myprog-upload-form select {
    width: 100%; padding: 10px; background: #0A0A0F; border: 1px solid #2D2D3F;
    border-radius: 8px; color: #fff; font-size: 13px; font-family: Inter, sans-serif;
    min-height: 44px; margin-bottom: 8px; box-sizing: border-box;
}
.m-myprog-upload-form textarea { min-height: 60px; resize: vertical; }
.m-myprog-upload-form input[type="file"] { margin-bottom: 10px; color: #A8A8B8; font-size: 13px; }
.m-myprog-upload-btn {
...
.m-myprog-vid-item {
    ...
    padding: 10px; margin-bottom: 6px; display: flex; gap: 10px; align-items: center;
}
.m-myprog-vid-thumb { width: 64px; height: 44px; border-radius: 6px; overflow: hidden; background: #0A0A0F; flex-shrink: 0; }
.m-myprog-vid-thumb img { width: 100%; height: 100%; object-fit: cover; }
.m-myprog-vid-info { flex: 1; min-width: 0; }
.m-myprog-vid-info h5 { font-size: 12px; font-weight: 600; color: #fff; margin: 0 0 2px; }
.m-myprog-vid-info span { font-size: 10px; color: #A8A8B8; }
...
/* Chat section */
.m-myprog-chat { margin-top: 16px; padding-top: 12px; border-top: 1px solid #2D2D3F; }
.m-myprog-chat-header { display: flex; align-items: center; justify-content: space-between; margin-bottom: 8px; }
.m-myprog-chat-title { font-size: 13px; font-weight: 600; color: #fff; }
...
.m-myprog-chat-msgs {
    ...
    display: flex; flex-direction: column; gap: 4px; padding: 8px 0; margin-bottom: 8px;
}
.m-myprog-chat-empty { color: #6B6B7B; font-size: 12px; text-align: center; padding: 20px; }
.m-myprog-chat-row { display: flex; max-width: 80%; }
.m-myprog-chat-row.from-me { align-self: flex-end; }
.m-myprog-chat-row.from-coach { align-self: flex-start; }
.m-myprog-chat-bubble { padding: 8px 12px; border-radius: 14px; font-size: 13px; line-height: 1.4; word-wrap: break-word; }
...
.m-myprog-chat-row.from-coach .m-myprog-chat-bubble { background: #0A0A0F; color: #fff; border: 1px solid #2D2D3F; border-bottom-left-radius: 4px; }
...
.m-myprog-chat-input { display: flex; gap: 8px; }
.m-myprog-chat-input input {
    flex: 1; padding: 10px 12px; background: #0A0A0F; border: 1px solid #2D2D3F;
    border-radius: 10px; color: #fff; font-size: 13px; min-height: 44px;
}
.m-myprog-chat-input input:focus { outline: none; border-color: #6B46C1; }
.m-myprog-chat-input button {
    padding: 10px 14px; background: #6B46C1; color: #fff; border: none;
    border-radius: 10px; cursor: pointer; font-weight: 600; font-size: 13px; min-height: 44px;
}
...
<div class="m-myprog">
    ...
    <div class="m-myprog-enroll">
        <div class="m-myprog-enroll-name">
        ...
        <!-- Assigned Drills (expandable) -->
        <?php if (!empty($enrollment['drills'])): ?>
        <div class="m-myprog-section-label"><i class="fas fa-dumbbell"></i> Assigned Drills (<?= count($enrollment['drills']) ?>)</div>
        ...
        <?php endforeach; ?>
        <?php else: ?>
        <div class="m-myprog-section-label"><i class="fas fa-dumbbell"></i> Assigned Drills</div>
        ...
        <!-- Video Upload -->
        <div class="m-myprog-section-label"><i class="fas fa-video"></i> Development Videos</div>
        <div class="m-myprog-upload">
            ...
            <div class="m-myprog-upload-opts">
                <div class="m-myprog-upload-opt" onclick="mShowUploadForm(<?= (int)$enrollment['id'] ?>, 'record')">
                    <i class="fas fa-circle-dot"></i>
                    <span>Record</span>
                </div>
                <div class="m-myprog-upload-opt" onclick="mShowUploadForm(<?= (int)$enrollment['id'] ?>, 'upload')">
            ...
            <div class="m-myprog-upload-form" id="m-upload-form-<?= (int)$enrollment['id'] ?>">
                ...
                <input type="file" id="m-vid-file-<?= (int)$enrollment['id'] ?>" accept="video/*" style="margin-bottom:10px;">
        ...
        <div style="margin-top:8px;">
            <div class="m-myprog-drills-label"><i class="fas fa-film"></i> Your Submitted Videos</div>
        ...
        <div class="m-myprog-chat">
            ...
            <div class="m-myprog-chat-msgs" id="m-chat-<?= (int)$enrollment['id'] ?>">
                ...
                <div class="m-myprog-chat-empty">No messages yet. Start a conversation with your coach.</div>
                <?php else: ?>
...
document.querySelectorAll('.m-myprog-chat-msgs').forEach(function(el) {
