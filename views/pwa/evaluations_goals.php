...
<div class="m-evalgoals">
    <div class="m-segment-control">
        <button class="m-segment m-segment-active" data-panel="goals" aria-pressed="true">
            <i class="fas fa-bullseye"></i> Goals (<?= count($goals) ?>)
        </button>
        <button class="m-segment" data-panel="evals" aria-pressed="false">
            <i class="fas fa-clipboard-check"></i> Evaluations (<?= count($evaluations) ?>)
        </button>
