    ...
    if (detailPlayer && typeof window.awInitHlsPlayer === 'function') {
        ...
        if (srcUrl) {
            if (typeof window.awReportPlaybackError === 'function') {
                window.awReportPlaybackError('Detail page (PWA): initializing video player', { view: 'pwa_video_review_detail', primaryUrl: srcUrl, fallbackUrl: detailPlayer.dataset.fallbackUrl || '', type: 'lifecycle' });
            }
