<?php
/**
 * Export / Import All Drills
 * Allows exporting all drills to JSON and importing from a JSON file
 */
...
<div class="export-import-container">
    ...
    <div class="ei-card">
        ...
        <div class="ei-card-title">Export All Drills</div>
    ...
    <div class="ei-card">
        ...
        <div class="ei-card-title">Import Drills from File</div>
        <div class="ei-card-desc">
            Upload a JSON file previously exported from this system to import drills, categories, and tags.
        </div>
        
        <div class="ei-info">
            <i class="fas fa-info-circle"></i> The import file must be a JSON file exported using the Export function. Drills will be created under your user account.
        </div>
        
        <form id="drill-import-form" enctype="multipart/form-data">
            <input type="hidden" name="action" value="import_json">
            <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($csrf_token) ?>">
            
            <input type="file" name="import_file" accept=".json" class="ei-file-input" id="drill-import-file" required>
            
            <label class="ei-checkbox">
                <input type="checkbox" name="skip_duplicates" value="1" checked>
                Skip drills that already exist (match by title)
            </label>
            
            <button type="submit" class="ei-btn ei-btn-import" id="drill-import-btn">
...
<script>
document.getElementById('drill-import-form').addEventListener('submit', function(e) {
    e.preventDefault();
    
    const fileInput = document.getElementById('drill-import-file');
