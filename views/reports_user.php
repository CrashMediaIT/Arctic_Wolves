...
<div class="user-reports">
    <div class="page-header">
        ...
        <div>
            <a href="process_users_email_export.php?csrf_token=<?php echo urlencode($_SESSION['csrf_token'] ?? ''); ?>" class="btn-export" data-action="link"><i class="fas fa-envelope"></i> Export Emails</a>
