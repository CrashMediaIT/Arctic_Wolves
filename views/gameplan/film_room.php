...
<div class="vr-upload-card">
    ...
    <form method="POST" action="/process_video.php" enctype="multipart/form-data" class="vr-upload-form" id="vrUploadForm">
        ...
        <div class="vr-form-actions">
            <button type="submit" class="vr-btn-primary"><i class="fas fa-upload"></i> Upload Source</button>
        </div>
    </form>
</div>

<!-- NDI Recording Panel -->
<div class="vr-ndi-panel">
    <h3 class="vr-section-title">NDI Camera Recording</h3>
    <div class="vr-ndi-status">
        <div class="vr-ndi-indicator"></div>
