...
// Fetch report
$stmt = $pdo->prepare("
    SELECT r.*, u.first_name as generated_by_first_name, u.last_name as generated_by_last_name
    FROM reports r
    ...
    <div class="report-header">
        ...
        <div class="report-meta">
            <div class="meta-item">
                ...
                Generated by: <?= htmlspecialchars(trim(($report['generated_by_first_name'] ?? '') . ' ' . ($report['generated_by_last_name'] ?? ''))) ?>
            </div>
            <div class="meta-item">
