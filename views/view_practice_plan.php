            ...
            <?php else: ?>
                <div class="drills-list">
                    <?php foreach ($drills as $index => $drill): ?>
                        ...
                        if ($hasCustomImage && strpos($drill['custom_image'], '..') === false && !preg_match('#^https?://#', $drill['custom_image']) && strpos($drill['custom_image'], 'uploads/') === 0 && !file_exists($drill['custom_image'])) {
