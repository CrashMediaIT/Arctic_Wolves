    ...
    <div id="goalModal" class="modal" style="display: none;">
        <div class="modal-content modal-lg">
            <div class="modal-header">
                ...
                <button class="modal-close" aria-label="Close modal" onclick="closeGoalModal()" aria-label="Close modal">&times;</button>
            </div>
    ...
    <div id="goalDetailModal" class="modal" style="display: none;">
        <div class="modal-content modal-lg">
            <div class="modal-header">
                ...
                <button class="modal-close" aria-label="Close modal" onclick="closeGoalDetailModal()" aria-label="Close modal">&times;</button>
            </div>
    ...
    <div id="progressNoteModal" class="modal" style="display: none;">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button class="modal-close" aria-label="Close modal" onclick="closeProgressNoteModal()" aria-label="Close modal">&times;</button>
            </div>
