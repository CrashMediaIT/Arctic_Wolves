...
try {
    ...
    switch ($action) {
        ...
        case 'update_smtp':
            ...
            $o365_connected_email = trim($_POST['office365_smtp_connected_email'] ?? '');
            ...
            if (!empty($o365_connected_email)) {
                updateSetting($pdo, 'office365_smtp_connected_email', $o365_connected_email);
            }
