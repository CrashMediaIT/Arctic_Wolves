...
test.describe('All upload views use server-proxied upload flow', () => {
  test('video_record_athlete.php should use get_video_upload_url and proxy', () => {
  ...
  test('video_coach_reviews.php should use proxy upload flow', () => {
    const content = readFile('views/video_coach_reviews.php');
    expect(content).toContain('proxy_video_upload');
    expect(content).toContain('confirm_athlete_upload');
  });

  test('gp_film_room.php should use get_video_upload_url and proxy', () => {
  ...
  test('film_room.php should use get_video_upload_url and proxy', () => {
  ...
  test('pwa/video_record_drill.php should use get_video_upload_url and proxy', () => {
